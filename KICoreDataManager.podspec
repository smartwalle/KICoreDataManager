#
#  Be sure to run `pod spec lint KICoreDataManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "杨烽"
  # s.authors            = { "杨烽" => "smartwalle@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/smartwalle/KICoreDataManager.git", :tag => "0.1" }
